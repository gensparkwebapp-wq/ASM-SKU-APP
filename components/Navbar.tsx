    ...
    <header className="sticky top-0 z-50 w-full glass border-b-0">
      <div className="flex h-16 items-center justify-between px-4 md:px-8 max-w-[1280px] mx-auto">
        ...
        <div className="flex items-center gap-3">
          <button className="hidden lg:flex bg-white/5 hover:bg-white/10 border border-white/10 rounded-full px-4 py-1.5 text-sm font-medium transition-colors items-center gap-2">
            <span>Sign In</span>
          </button>
